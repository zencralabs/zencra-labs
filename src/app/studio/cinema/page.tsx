...
const TAKEOVER_CARDS: TakeoverCard[] = [
  ...
  { title: "Character Consistency", category: "CHARACTERS",     desc: "Maintain identity, appearance, and motion across every scene.",                          Icon: UserSquare2, poster: "/cinema-stills/still-3.svg", video: "/cinema-previews/preview-3.mp4", motionKey: "focusShift",   origin: "100% 0%"  },

...
const CD_MODELS: CDModel[] = [
  ...
  { value: "gpt-image-1",     label: "GPT Image 1.5",      provider: "openai",       supportedResolutions: ["1k", "2k"],        defaultQuality: "medium", baseCredits: 15, maxUploads: 16 },
  ...
  { value: "seedream-v5",     label: "Seedream v5",  provider: "fal",          supportedResolutions: ["1k", "2k"],        defaultQuality: "low",    baseCredits: 15, maxUploads: 14 },

...
export const FAL_MODEL_IDS = {
  ...
  seedream45:      optional("FAL_MODEL_SEEDREAM_45",      "fal-ai/bytedance/seedream/v4.5/text-to-image") as string,
  // Edit path — separate key so it can be overridden independently in env.
  seedream45Edit:  optional("FAL_MODEL_SEEDREAM_45_EDIT", "fal-ai/bytedance/seedream/v4.5/edit") as string,

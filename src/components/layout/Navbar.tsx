            ...
            {!mounted || (loading && !user) ? (
              ...
              <div className="hidden items-center gap-3 lg:flex">
                ...
                >
                  ...
                  <span suppressHydrationWarning style={{ fontFamily: "var(--font-display)", fontSize: "16px", fontWeight: 700, color: "#DBEAFE", letterSpacing: "-0.02em", lineHeight: 1, fontVariantNumeric: "tabular-nums", minWidth: 46, display: "inline-block" }}>

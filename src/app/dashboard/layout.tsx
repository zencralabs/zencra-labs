          ...
          {isFree ? (
            ...
            <div style={{ marginTop: "12px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "5px" }}>
                ...
                <span style={{ fontFamily: "var(--font-display)", fontSize: "16px", fontWeight: 700, color: "#DBEAFE", letterSpacing: "-0.02em", fontVariantNumeric: "tabular-nums" }}>{user.credits.toLocaleString()}</span>
              </div>

  ...
  return (
    <div style={{ backgroundColor: "#080E1C", color: "#F8FAFC", minHeight: "100vh" }}
      ...
      <div className="pointer-events-none fixed inset-0" aria-hidden="true"
        style={{ background: "radial-gradient(ellipse at 50% 30%, rgba(37,99,235,0.12) 0%, transparent 70%)" }} />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl p-8" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <p className="mb-7 text-sm" style={{ color: "#64748B" }}>Sign in to your Zencra Labs account</p>
          ...
          <form onSubmit={e => e.preventDefault()} className="flex flex-col gap-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label className="text-xs font-semibold uppercase tracking-wider" style={{ color: "#475569" }}>Password</label>
                <a href="#" className="text-xs transition-colors" style={{ color: "#2563EB" }}
              ...
              <div className="relative">
                <input type={show ? "text" : "password"} placeholder="••••••••" required value={form.password}
            ...
            <button type="submit"
              className="mt-1 flex items-center justify-center gap-2 rounded-xl px-6 py-3.5 text-sm font-semibold text-white transition-all duration-300"
              style={{ background: "linear-gradient(135deg, #2563EB 0%, #0EA5A0 100%)", boxShadow: "0 0 25px rgba(37,99,235,0.35)" }}
              ...
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.boxShadow = "0 0 25px rgba(37,99,235,0.35)"; (e.currentTarget as HTMLElement).style.transform = "none"; }}>
